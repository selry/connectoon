...
<body>
 <% if(session.getAttribute("login_user")==null){ %>
	...
	alert('로그인 한 유저만 사용할 수 있는 페이지 입니다.');
 ...
 <% }%>
    <div class="wrap">
        ...
        <section class="section">
            <div class="edit">
                <button class="btn_goback"><span class="blind">뒤로 가기</span></button>
                <div class="edit_favorite">
                    <button class="btn_edit_favorite">편집</button>
                </div>
            </div>
            <div class="view">
